...
const STRINGS = {
  en: {
    ...
    wishlistWithCount: "Wishlist ({count})",
    cartTitle: "Your cart",
    cartEmptyTitle: "Your cart is empty",
    cartEmptyBody: "Add a product from the catalogue to see it here.",
    total: "Total",
    ...
    enquirySignInPrompt: "Sign in to ask a question about this product.",
    enquirySent: "Question sent. We will follow up soon.",
  ...
  es: {
    ...
    accountLabel: "Cuenta",
    yourName: "Tu nombre",
    namePlaceholder: "p. ej. Priya Shah",
    signIn: "Iniciar sesión",
    signedInAs: "Sesión iniciada como {name}",
    signOut: "Cerrar sesión",
    cartWithCount: "Carrito ({count})",
    wishlistWithCount: "Lista de deseos ({count})",
    cartTitle: "Tu carrito",
    cartEmptyTitle: "Tu carrito está vacío",
    cartEmptyBody: "Añade un producto del catálogo para verlo aquí.",
    total: "Total",
    decreaseQuantity: "Reducir cantidad",
    increaseQuantity: "Aumentar cantidad",
    removeLine: "Quitar",
    wishlistTitle: "Tu lista de deseos",
    wishlistEmptyTitle: "Nada guardado todavía",
    wishlistEmptyBody: "Toca el corazón de un producto para guardarlo aquí.",
    addToWishlist: "Guardar en la lista de deseos",
    removeFromWishlist: "Quitar de la lista de deseos",
    view: "Ver",
    addToCart: "Añadir al carrito",
    askAQuestion: "Hacer una pregunta",
    questionLabel: "Tu pregunta",
    questionPlaceholder: "Pregunta sobre este producto",
    sendQuestion: "Enviar pregunta",
    enquirySignInPrompt: "Inicia sesión para preguntar sobre este producto.",
    enquirySent: "Pregunta enviada. Te responderemos pronto.",
  ...
  fr: {
    ...
    accountLabel: "Compte",
    yourName: "Votre nom",
    namePlaceholder: "p. ex. Priya Shah",
    signIn: "Se connecter",
    signedInAs: "Connecté en tant que {name}",
    signOut: "Se déconnecter",
    cartWithCount: "Panier ({count})",
    wishlistWithCount: "Liste de souhaits ({count})",
    cartTitle: "Votre panier",
    cartEmptyTitle: "Votre panier est vide",
    cartEmptyBody: "Ajoutez un produit du catalogue pour le voir ici.",
    total: "Total",
    decreaseQuantity: "Diminuer la quantité",
    increaseQuantity: "Augmenter la quantité",
    removeLine: "Retirer",
    wishlistTitle: "Votre liste de souhaits",
    wishlistEmptyTitle: "Rien d'enregistré pour l'instant",
    wishlistEmptyBody: "Touchez le coeur d'un produit pour l'enregistrer ici.",
    ...
    questionPlaceholder: "Posez une question sur ce produit",
    sendQuestion: "Envoyer la question",
    enquirySignInPrompt: "Connectez-vous pour poser une question sur ce produit.",
    enquirySent: "Question envoyée. Nous reviendrons vers vous bientôt.",
  ...
  de: {
    ...
    accountLabel: "Konto",
    yourName: "Ihr Name",
    namePlaceholder: "z. B. Priya Shah",
    signIn: "Anmelden",
    signedInAs: "Angemeldet als {name}",
    signOut: "Abmelden",
    cartWithCount: "Warenkorb ({count})",
    wishlistWithCount: "Wunschliste ({count})",
    cartTitle: "Ihr Warenkorb",
    cartEmptyTitle: "Ihr Warenkorb ist leer",
    cartEmptyBody: "Fügen Sie ein Produkt aus dem Katalog hinzu, um es hier zu sehen.",
    total: "Summe",
    decreaseQuantity: "Menge verringern",
    increaseQuantity: "Menge erhöhen",
    removeLine: "Entfernen",
    wishlistTitle: "Ihre Wunschliste",
    wishlistEmptyTitle: "Noch nichts gespeichert",
    wishlistEmptyBody: "Tippen Sie auf das Herz eines Produkts, um es hier zu speichern.",
    ...
    questionPlaceholder: "Fragen Sie zu diesem Produkt",
    sendQuestion: "Frage senden",
    enquirySignInPrompt: "Melden Sie sich an, um eine Frage zu diesem Produkt zu stellen.",
    enquirySent: "Frage gesendet. Wir melden uns bald.",
  ...
  ja: {
    ...
    wishlistWithCount: "お気に入り（{count}）",
    cartTitle: "カート",
    cartEmptyTitle: "カートは空です",
    cartEmptyBody: "カタログから商品を追加するとここに表示されます。",
    total: "合計",
    decreaseQuantity: "数量を減らす",
    increaseQuantity: "数量を増やす",
    removeLine: "削除",
    wishlistTitle: "お気に入り",
    wishlistEmptyTitle: "まだ保存された商品はありません",
    wishlistEmptyBody: "商品のハートマークをタップするとここに保存されます。",
    ...
    askAQuestion: "質問する",
    questionLabel: "質問内容",
    questionPlaceholder: "この商品について質問する",
    sendQuestion: "質問を送信",
    enquirySignInPrompt: "この商品について質問するにはサインインしてください。",
    enquirySent: "質問を送信しました。追ってご連絡します。",
